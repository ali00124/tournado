					...
					<form class="form-area " id="myForm" action="mail.php" method="post" class="contact-form text-right">
						<div class="row">	
							<div class="col-lg-6 form-group">
								...
								<p>Please fill out the quick form and we will be in touch with you.</p>
							...
							<div class="col-lg-6 form-group">
								...
								<p> <b>For support or any questions: <br><br> Email us at: tournado@tss.com. <br><br> Or contact us at: <br><br> Talha Ahmed: <br><br> XXXX-XXXXXXX <br><br> Follow us on the social media: </b></p>
