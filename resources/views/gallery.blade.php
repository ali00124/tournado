			...
			<section class="banner-area" id="home">
				...
				<section class = "mb-50 mt-50">
					...
					<div class="section-top-border">
						<h3 align = "center">The Places We Have Explored</h3>
						<div class="row gallery-item">
							<div class="col-md-4">
								<a href="img/gallery/g1.jpg" class="img-pop-up"><div class="single-gallery-image" style="background: url(img/gallery/g1.jpg);"></div></a>
							</div>
							<div class="col-md-4">
								<a href="img/gallery/g2.jpg" class="img-pop-up"><div class="single-gallery-image" style="background: url(img/gallery/g2.jpg);"></div></a>
							</div>
							<div class="col-md-4">
								<a href="img/gallery/g3.jpg" class="img-pop-up"><div class="single-gallery-image" style="background: url(img/gallery/g3.jpg);"></div></a>
							</div>
							<div class="col-md-6">
								<a href="img/gallery/g4.jpg" class="img-pop-up"><div class="single-gallery-image" style="background: url(img/gallery/g4.jpg);"></div></a>
							</div>
							<div class="col-md-6">
								<a href="img/gallery/g5.jpg" class="img-pop-up"><div class="single-gallery-image" style="background: url(img/gallery/g5.jpg);"></div></a>
							</div>
														<div class="col-md-4">
								<a href="img/gallery/g1.jpg" class="img-pop-up"><div class="single-gallery-image" style="background: url(img/gallery/g1.jpg);"></div></a>
							</div>
